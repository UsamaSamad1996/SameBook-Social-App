      ...
      >
        <div className="shareTop flex p-2 mb-2 flex-auto items-center">
          <Link to="/Profile">
            {" "}
            <img
              className="h-14 w-16 rounded-full object-cover border-2 border-sky-300"
              src={profileImage}
              alt="no poster"
            />
          </Link>
        ...
        <div className="sharebottom flex pt-3 flex-wrap flex-auto items-center justify-evenly">
          <button className="py-1 px-2 my-1  bg-sky-400 text-white text-lg font-semibold rounded-md flex items-center">
